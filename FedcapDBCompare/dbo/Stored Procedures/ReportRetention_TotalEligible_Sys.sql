...
CREATE PROCEDURE [dbo].[ReportRetention_TotalEligible_Sys]
	@Date_From DATETIME,
	@Date_To DATETIME,
	@companyId int,
	@RetentionId int
...
FROM            dbo.PlacementEntry with(nolock) left outer join
...
AND
(Enume_1.Item NOT LIKE '%Not%')					-- dbo.PlacementEntry.BillingTypeId <> 35) 
AND 
