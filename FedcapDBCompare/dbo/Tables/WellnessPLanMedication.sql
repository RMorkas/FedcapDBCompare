CREATE TABLE [dbo].[WellnessPLanMedication] (
    [WellnessPLanMedicationId] INT          IDENTITY (1, 1) NOT NULL,
    [WellnessPLanId]           INT          NULL,
    [MedicationName]           VARCHAR (80) NULL,
    [Dosage]                   VARCHAR (80) NULL,
    [PrescribingPhysician]     VARCHAR (80) NULL,
    [ParentLastSave]           DATETIME     NULL,
    CONSTRAINT [PK_WellnessPLanMedication] PRIMARY KEY CLUSTERED ([WellnessPLanMedicationId] ASC),
    CONSTRAINT [FK_WellnessPLanMedication_WellnessPLan] FOREIGN KEY ([WellnessPLanId]) REFERENCES [dbo].[WellnessPLan] ([WellnessPLanId])
);


GO

CREATE TRIGGER [dbo].[MedicationLog] ON [dbo].[WellnessPLanMedication] 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'WellnessPLanMedication'
