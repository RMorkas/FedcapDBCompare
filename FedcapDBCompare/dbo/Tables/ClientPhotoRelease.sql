CREATE TABLE [dbo].[ClientPhotoRelease] (
    [ClientPhotoReleaseId]  INT           IDENTITY (1, 1) NOT NULL,
    [CompanyId]             INT           NULL,
    ...
    [IsLocked]              BIT           CONSTRAINT [DF_ClientPhotoRelease_IsLocked] DEFAULT ((0)) NOT NULL,
    [IsDeleted]             BIT           CONSTRAINT [DF_ClientPhotoRelease_IsDeleted] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_ClientPhotoRelease] PRIMARY KEY CLUSTERED ([ClientPhotoReleaseId] ASC),
    CONSTRAINT [FK_ClientPhotoRelease_Client] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([ClientId])
);


GO
create TRIGGER [dbo].[ClientPhotoReleaseLog] ON [dbo].[ClientPhotoRelease] 
FOR UPDATE , INSERT
AS
...
SET @RetryCount = 0
SET @MaxRetry = 3
Set @TableName = N'ClientPhotoRelease'
