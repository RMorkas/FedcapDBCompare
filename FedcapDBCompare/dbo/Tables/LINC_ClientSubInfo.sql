CREATE TABLE [dbo].[LINC_ClientSubInfo] (
    [ClientSubInfoId]         INT             IDENTITY (1, 1) NOT NULL,
    [ClientId]                INT             NULL,
    [IsRentalArrears]         BIT             NULL,
    [IsRentBreakDown]         BIT             NULL,
    [ArrearsAmount]           NUMERIC (18, 2) NULL,
    [IsRentalArrearsPaid]     BIT             NULL,
    [PaymentDate]             SMALLDATETIME   NULL,
    [PaymentAmount]           NUMERIC (18, 2) NULL,
    [IsReferedToHomeBase]     BIT             NULL,
    [HomeBaseDate]            SMALLDATETIME   NULL,
    [IsB2WRetention]          BIT             NULL,
    [IsEmploymentWorks]       BIT             NULL,
    [LINCRenewalDate]         SMALLDATETIME   NULL,
    [IsLINCRenewalSubmit]     BIT             NULL,
    [LINCSubmittedDate]       SMALLDATETIME   NULL,
    [LINCVoucherRenewed]      BIT             NULL,
    [LINCVoucherDate]         SMALLDATETIME   NULL,
    [AttainedNewEmployment]   BIT             NULL,
    [ReferredToTraining]      BIT             NULL,
    [CustomerAppearedInCourt] BIT             NULL,
    [CourtDate]               SMALLDATETIME   NULL,
    [IsReferredToHousing]     BIT             NULL,
    [HousingReferralDate]     SMALLDATETIME   NULL,
    [ShelterName]             VARCHAR (80)    NULL,
    [RentTypeId]              INT             NULL,
    [AcutalRent]              NUMERIC (18, 2) NULL,
    [Contribution]            NUMERIC (18, 2) NULL,
    [Subsidy]                 NUMERIC (18, 2) NULL,
    [MasterNote]              VARCHAR (300)   NULL,
    [CompleteServicePlan]     BIT             NULL,
    [MadeContactWithLandlord] BIT             NULL,
    [SpanishSpeaker]          BIT             NULL,
    ...
    CONSTRAINT [PK_LINC_ClientSubInfo] PRIMARY KEY CLUSTERED ([ClientSubInfoId] ASC)
);


GO
CREATE TRIGGER [dbo].[ClientSubInfoLog] ON [dbo].[LINC_ClientSubInfo] 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'LINC_ClientSubInfo'
SET @ChildPKName = 'ClientSubInfoId'
