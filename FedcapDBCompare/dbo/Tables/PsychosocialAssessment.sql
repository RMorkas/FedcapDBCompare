CREATE TABLE [dbo].[PsychosocialAssessment] (
    [PsychosocialAssessmentId]                  INT            IDENTITY (1, 1) NOT NULL,
    [ClientId]                                  INT            NOT NULL,
    [MedicalProblemDescription]                 VARCHAR (2000) NULL,
    [MedicalHistory]                            VARCHAR (2000) NULL,
    [HasBeenHospitalized]                       BIT            NULL,
    [HasReceivedMedicalTreatment]               BIT            NULL,
    [IsCurrentlyOnMedicalTreatment]             BIT            NULL,
    [LastMedicalAppointment]                    DATETIME       NULL,
    [HasRegularMedicalAppointments]             BIT            NULL,
    [IsCurrentlyOnMedication]                   BIT            NULL,
    [HasMentalHealthConditions]                 BIT            NULL,
    [MentalHealthDiagnosis]                     VARCHAR (2000) NULL,
    [HasToldProviderAboutMentalHealthProblem]   BIT            NULL,
    [HasReceivedMentalHealthTreatment]          BIT            NULL,
    [IsCurrentlyReceivingMentalHealthTreatment] BIT            NULL,
    [HadPastThoughtsAboutHurtingSelf]           BIT            NULL,
    [HasCurrentThoughtsAboutHurtingSelf]        BIT            NULL,
    [HadPastThoughtsAboutHurtingOthers]         BIT            NULL,
    [HasCurrentThoughtsAboutHurtingOthers]      BIT            NULL,
    [HasUnusualBehavior]                        BIT            NULL,
    [MentalHealthAdditionalComments]            VARCHAR (2000) NULL,
    [IsCurrentlyUsingDrugs]                     BIT            NULL,
    [HasHistoryOfSubstanceAbuse]                BIT            NULL,
    [HasReceivedTreatmentForSubstanceAbuse]     BIT            NULL,
    [IsCurrentlyInTreatmentForSubstanceAbuse]   BIT            NULL,
    [WantsSubstanceAbuseCounseling]             BIT            NULL,
    [SubstanceAbuseAdditionalComments]          VARCHAR (2000) NULL,
    [UsesTobaccoProducts]                       BIT            NULL,
    [HasUsedTobaccoProductsInPast]              BIT            NULL,
    [WantsSmokingCessationProgram]              BIT            NULL,
    [IsReceivingOtherService]                   BIT            NULL,
    [OtherServiceProviderAdditionalComments]    VARCHAR (2000) NULL,
    [RelationshipStatusId]                      INT            NULL,
    [NumChildren]                               INT            NULL,
    [CaresForSickFamilyMember]                  BIT            NULL,
    [IsWalking]                                 BIT            NULL,
    [IsClimbingStairs]                          BIT            NULL,
    [IsHearing]                                 BIT            NULL,
    [IsSeeing]                                  BIT            NULL,
    [IsBathing]                                 BIT            NULL,
    [IsGrooming]                                BIT            NULL,
    [IsToileting]                               BIT            NULL,
    [IsPreparingMeals]                          BIT            NULL,
    [IsHosekeeping]                             BIT            NULL,
    [DailyActivitiesElaboration]                VARCHAR (2000) NULL,
    [IsSocializing]                             BIT            NULL,
    [IsMemberOfCommunityOrganization]           BIT            NULL,
    [OtherActivitiesElaboration]                VARCHAR (2000) NULL,
    [Signature]                                 VARCHAR (MAX)  NULL,
    [PsychosocialAssessmentDate]                DATETIME       NULL,
    ...
    [IsLocked]                                  BIT            CONSTRAINT [DF_PsychosocialAssessment_IsLocked] DEFAULT ((0)) NOT NULL,
    [IsDeleted]                                 BIT            CONSTRAINT [DF_PsychosocialAssessment_IsDeleted] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_PsychosocialAssessment] PRIMARY KEY CLUSTERED ([PsychosocialAssessmentId] ASC),
    CONSTRAINT [FK_PsychosocialAssessment_Client] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([ClientId]),
    CONSTRAINT [FK_PsychosocialAssessment_FormVersion] FOREIGN KEY ([FormVersionId]) REFERENCES [dbo].[FormVersion] ([FormVersionId])
);


GO
CREATE TRIGGER [dbo].[PsychosocialAssessmentLog] ON [dbo].[PsychosocialAssessment] 
FOR UPDATE , INSERT
AS
...
SET @RetryCount = 0
SET @MaxRetry = 3
Set @TableName = N'PsychosocialAssessment'
...
****************************
*/
Set @ChildTableName = 'PsychosocialAssessmentActivity'
SET @ChildPKName = 'PsychosocialAssessmentActivityId'
