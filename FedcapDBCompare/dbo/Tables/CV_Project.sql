CREATE TABLE [dbo].[CV_Project] (
    ...
    CONSTRAINT [PK_CV_Project] PRIMARY KEY CLUSTERED ([ProjectId] ASC),
    CONSTRAINT [FK_CV_Project_CV_Resume] FOREIGN KEY ([ResumeId]) REFERENCES [dbo].[CV_BaseResume] ([ResumeId])
);


GO
CREATE TRIGGER [dbo].[projectLog] ON [dbo].[CV_Project] 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'CV_Project'
SET @ChildPKName = 'ProjectId'
