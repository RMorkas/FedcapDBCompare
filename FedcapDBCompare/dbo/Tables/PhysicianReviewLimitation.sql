CREATE TABLE [dbo].[PhysicianReviewLimitation] (
    [PhysicianReviewLimitationId] INT      IDENTITY (1, 1) NOT NULL,
    [PhysicianReviewId]           INT      NULL,
    [LimitationId]                INT      NULL,
    [ParentLastSave]              DATETIME NULL,
    CONSTRAINT [PK_PhysicianReviewLimitation] PRIMARY KEY CLUSTERED ([PhysicianReviewLimitationId] ASC),
    CONSTRAINT [FK_PhysicianReviewLimitation_PhysicianReview] FOREIGN KEY ([PhysicianReviewId]) REFERENCES [dbo].[PhysicianReview] ([PhysicianReviewId])
);


GO
CREATE TRIGGER [dbo].[PhysicianReviewLimitationLog] ON [dbo].[PhysicianReviewLimitation] 
FOR UPDATE , INSERT
AS
...
SET @PartentTable = 'PhysicianReview'
Set @TableName = N'PhysicianReviewLimitation'
