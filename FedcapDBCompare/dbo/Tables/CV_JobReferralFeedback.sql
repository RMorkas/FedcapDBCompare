CREATE TABLE [dbo].[CV_JobReferralFeedback] (
    [FeedbackId]              INT           IDENTITY (1, 1) NOT NULL,
    [JobReferralId]           INT           NULL,
    [JobOffered]              BIT           NULL,
    [ClientAccepted]          BIT           NULL,
    [ClientMetInterviewer]    BIT           NULL,
    [SecondInterviewSchedule] BIT           NULL,
    [SecondInterviewDate]     SMALLDATETIME NULL,
    [SecondInterviewTime]     DATETIME      NULL,
    [Feedback]                VARCHAR (350) NULL,
    [CreatedBy]               VARCHAR (80)  NULL,
    [CreatedAt]               DATETIME      NULL,
    [UpdatedBy]               VARCHAR (80)  NULL,
    [UpdatedAt]               DATETIME      NULL,
    CONSTRAINT [PK_CV_JobReferralFeedbak] PRIMARY KEY CLUSTERED ([FeedbackId] ASC),
    CONSTRAINT [FK_CV_JobReferralFeedbak_CV_JobReferrals] FOREIGN KEY ([JobReferralId]) REFERENCES [dbo].[CV_JobReferral] ([JobReferralId])
);


GO
CREATE TRIGGER [dbo].[feedbackLog] ON [dbo].[CV_JobReferralFeedback] 
FOR UPDATE , INSERT
AS
...
SET @PartentTable = 'CV_JobReferral'
Set @TableName = N'CV_JobReferralFeedback'
SET @ChildPKName = 'FeedbackId'
