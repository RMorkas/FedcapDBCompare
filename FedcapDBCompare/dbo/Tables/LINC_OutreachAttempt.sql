CREATE TABLE [dbo].[LINC_OutreachAttempt] (
    [OutreachTrackId]     INT           IDENTITY (1, 1) NOT NULL,
    [ClientId]            INT           NULL,
    [OutreachDate]        SMALLDATETIME NULL,
    [OutreachMethodId]    INT           NULL,
    [OutreachTime]        DATETIME      NULL,
    [FedCapExtension]     VARCHAR (20)  NULL,
    [OutreachDuration]    VARCHAR (20)  NULL,
    [OutreachOutComeId]   INT           NULL,
    [IsFollowUpScheduled] INT           NULL,
    [FollowUpDate]        SMALLDATETIME NULL,
    [IsCustomerAttended]  INT           NULL,
    [OutreachComment]     VARCHAR (300) NULL,
    [CreatedBy]           VARCHAR (80)  NULL,
    [CreatedAt]           DATETIME      NULL,
    [UpdatedBy]           VARCHAR (80)  NULL,
    [UpdatedAt]           DATETIME      NULL,
    CONSTRAINT [PK_LINC_OutreachAttempt] PRIMARY KEY CLUSTERED ([OutreachTrackId] ASC),
    CONSTRAINT [FK_LINC_OutreachAttempt_Client] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([ClientId])
);


GO
CREATE TRIGGER [dbo].[OutreachAttemptLog] ON [dbo].[LINC_OutreachAttempt] 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'LINC_OutreachAttempt'
SET @ChildPKName = 'OutreachTrackId'
...
While (@index <= @count)
	...
	END
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Calls only in minutes', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'LINC_OutreachAttempt', @level2type = N'COLUMN', @level2name = N'OutreachDuration';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Read from Enum', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'LINC_OutreachAttempt', @level2type = N'COLUMN', @level2name = N'OutreachOutComeId';
