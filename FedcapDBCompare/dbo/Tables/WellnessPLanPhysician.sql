CREATE TABLE [dbo].[WellnessPLanPhysician] (
    [WellnessPLanPhysicianId] INT            IDENTITY (1, 1) NOT NULL,
    [WellnessPLanId]          INT            NULL,
    [ProviderName]            VARCHAR (80)   NULL,
    [MedicalSpecialtyId]      INT            NULL,
    [ProviderPhone]           VARCHAR (80)   NULL,
    [ProviderStreetAddress]   VARCHAR (80)   NULL,
    [ProviderStreetAddress2]  VARCHAR (80)   NULL,
    [ProviderCity]            VARCHAR (80)   NULL,
    [ProviderState]           VARCHAR (10)   NULL,
    [ProviderZip]             VARCHAR (80)   NULL,
    [Affiliation]             VARCHAR (80)   NULL,
    [IsClientSelected]        BIT            NULL,
    [Condition]               VARCHAR (80)   NULL,
    [ProviderComment]         VARCHAR (3000) NULL,
    [ParentLastSave]          DATETIME       NULL,
    CONSTRAINT [PK_WellnessPLanPhysician] PRIMARY KEY CLUSTERED ([WellnessPLanPhysicianId] ASC),
    CONSTRAINT [FK_WellnessPLanPhysician_WellnessPLan] FOREIGN KEY ([WellnessPLanId]) REFERENCES [dbo].[WellnessPLan] ([WellnessPLanId])
);


GO
CREATE TRIGGER [dbo].[PhysicianLog] ON dbo.WellnessPLanPhysician 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'WellnessPLanPhysician'
