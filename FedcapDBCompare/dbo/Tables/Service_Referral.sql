CREATE TABLE [dbo].[Service_Referral] (
    ...
    [ImportDate]                          DATETIME        CONSTRAINT [DF_Service_Referral_ImportDate] DEFAULT (getdate()) NULL,
    [Processed]                           BIT             CONSTRAINT [DF_Service_Referral_Processed] DEFAULT ((0)) NULL,
    [Scheduled]                           BIT             CONSTRAINT [DF_Service_Referral_Scheduled] DEFAULT ((0)) NULL,
