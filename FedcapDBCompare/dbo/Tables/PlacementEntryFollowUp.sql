...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N' 1 Office visit ; 2 Phone ; 3 Email ;', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'PlacementEntryFollowUp', @level2type = N'COLUMN', @level2name = N'FollowUpType';
