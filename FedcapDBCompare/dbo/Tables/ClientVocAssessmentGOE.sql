CREATE TABLE [dbo].[ClientVocAssessmentGOE] (
    [ClientVocAssessmentGOEId] INT            IDENTITY (1, 1) NOT NULL,
    [VocAssessmentId]          INT            NULL,
    [GOECode]                  VARCHAR (80)   NULL,
    [GOEDescription]           VARCHAR (3000) NULL,
    [ParentLastSave]           DATETIME       NULL,
    CONSTRAINT [PK_ClientVocAssessmentGOE] PRIMARY KEY CLUSTERED ([ClientVocAssessmentGOEId] ASC),
    CONSTRAINT [FK_ClientVocAssessmentGOE_ClientVocAssessment] FOREIGN KEY ([VocAssessmentId]) REFERENCES [dbo].[ClientVocAssessment] ([VocAssessmentId])
);


GO
CREATE TRIGGER [dbo].[VocGOELog] ON dbo.ClientVocAssessmentGOE 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'ClientVocAssessmentGOE'
