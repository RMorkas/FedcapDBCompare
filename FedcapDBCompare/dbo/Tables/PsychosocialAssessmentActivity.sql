CREATE TABLE [dbo].[PsychosocialAssessmentActivity] (
    [PsychosocialAssessmentActivityId] INT           IDENTITY (1, 1) NOT NULL,
    [PsychosocialAssessmentId]         INT           NULL,
    [Activity]                         VARCHAR (100) NULL,
    [ActivityFrequencyId]              INT           NULL,
    [ParentLastSave]                   DATETIME      NULL,
    CONSTRAINT [PK_PsychosocialAssessmentActivity] PRIMARY KEY CLUSTERED ([PsychosocialAssessmentActivityId] ASC),
    CONSTRAINT [FK_PsychosocialAssessmentActivity_PsychosocialAssessment] FOREIGN KEY ([PsychosocialAssessmentId]) REFERENCES [dbo].[PsychosocialAssessment] ([PsychosocialAssessmentId])
);


GO
CREATE TRIGGER [dbo].[PsychosocialAssessmentActivityLog] ON [dbo].[PsychosocialAssessmentActivity] 
FOR UPDATE , INSERT
AS
...
SET @PartentTable = 'PsychosocialAssessment'
Set @TableName = N'PsychosocialAssessmentActivity'
