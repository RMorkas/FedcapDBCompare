CREATE TABLE [dbo].[LINC_UpdatedClientInfo] (
    [UpdateClientInfoId] INT           IDENTITY (1, 1) NOT NULL,
    [ClientId]           INT           NULL,
    [NewPhone]           VARCHAR (25)  NULL,
    [NewEmail]           VARCHAR (50)  NULL,
    [NewAddress]         VARCHAR (100) NULL,
    [NewCity]            VARCHAR (25)  NULL,
    [NewState]           VARCHAR (25)  NULL,
    [NewZipCode]         INT           NULL,
    [ReturnToShelter]    BIT           NULL,
    [NewShelterName]     VARCHAR (80)  NULL,
    [CreatedBy]          VARCHAR (80)  NULL,
    [CreatedAt]          DATETIME      NULL,
    [UpdatedBy]          VARCHAR (80)  NULL,
    [UpdatedAt]          DATETIME      NULL,
    CONSTRAINT [PK_LINC_UpdatedClientInfo] PRIMARY KEY CLUSTERED ([UpdateClientInfoId] ASC),
    CONSTRAINT [FK_LINC_UpdatedClientInfo_Client] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([ClientId])
);


GO

CREATE TRIGGER [dbo].[UpdatedClientInfo] ON [dbo].[LINC_UpdatedClientInfo] 
FOR UPDATE , INSERT
AS
...
Set @TableName = N'LINC_UpdatedClientInfo'
SET @ChildPKName = 'UpdateClientInfoId'
