CREATE VIEW dbo.Search_VW_Placement_R1
AS
SELECT        dbo.PlacementEntry.PlacementEntryID, dbo.PlacementEntry.HRACaseID, dbo.PlacementEntry.EmpLocationId, HRACases_1.CaseFirstName, 
                         ...
                         dbo.PlacementEntry.EndDate, 101) AS EndDate
FROM            dbo.Employer INNER JOIN
                         dbo.PlacementEntry ON dbo.Employer.EmployerId = dbo.PlacementEntry.EmployerId INNER JOIN
                         ALLSECTOR.Arborfedcap_RPT_R1.dbo.HRACases AS HRACases_1 ON dbo.PlacementEntry.HRACaseID = HRACases_1.HRACaseID INNER JOIN
                         dbo.EmployerLocation ON dbo.PlacementEntry.EmpLocationId = dbo.EmployerLocation.EmpLocationId
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 50
         ...
         Width = 1500
         Width = 1500
       ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Search_VW_Placement_R1';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'Search_VW_Placement_R1';
