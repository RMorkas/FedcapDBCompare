...
SqlPackage.exe /a:publish /tcs:"Data Source=192.168.17.3;Initial Catalog=FedcapStaticData;Integrated Security=True" /sf:""C:\TFSAgent\_work\2\s\FedcapDBCompare\bin\Debug\FedcapDBCompare.dacpac"" /p:RegisterDataTierApplication=true /p:BlockWhenDriftDetected=false